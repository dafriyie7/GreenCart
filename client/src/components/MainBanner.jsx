...
const MainBanner = () => {
	return (
		<div className="relative">
			...
			<div
				className="absolute inset-0 flex flex-col items-center md:items-start justify-end md:justify-center pb-24 md:pb-0 px-4 md:pl-18
			 lg:pl-24"
			>
				...
				<div className="flex items-center mt-6 font-medium">
					...
					>
						...
						<img
							...
							alt="arrow"
							className="transision group-hover:translate-x-1"
						/>
					</Link>
				</div>
			</div>
